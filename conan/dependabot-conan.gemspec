...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-conan"
  spec.summary      = "Provides Dependabot support for Conan"
  spec.description  = "Dependabot-Conan provides support for bumping Conan dependencies via Dependabot. " \

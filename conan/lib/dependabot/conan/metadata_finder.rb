...
# you can safely delete this file and remove the require from lib/dependabot/conan.rb
...
Dependabot::MetadataFinders.register("conan", Dependabot::Conan::MetadataFinder)
